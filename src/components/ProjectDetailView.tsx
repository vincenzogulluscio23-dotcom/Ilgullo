    ...
    <div className="pt-28 pb-24 px-4 sm:px-6 lg:px-12 bg-[#09090A] min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 py-8 px-6 rounded-2xl bg-[#121214] border border-[#28282D] font-mono text-xs mb-16">
          <div>
            <span className="text-[#8D8D89] uppercase tracking-wider block mb-1">Cliente</span>
            <span className="text-white font-sans text-sm font-medium">{project.client}</span>
          </div>
          <div>
            <span className="text-[#8D8D89] uppercase tracking-wider block mb-1">Ruolo</span>
            <span className="text-white font-sans text-sm font-medium">{project.role}</span>
          </div>
          <div>
            <span className="text-[#8D8D89] uppercase tracking-wider block mb-1">Anno</span>
            <span className="text-white font-sans text-sm font-medium">{project.year}</span>
          </div>
          <div>
            <span className="text-[#8D8D89] uppercase tracking-wider block mb-1">Sede</span>
        ...
        <div className="space-y-16 max-w-4xl mx-auto mb-20">
          ...
          <div className="border-l-2 border-[#FF5A36] pl-6 py-1">
            ...
            <h3 className="font-serif italic text-2xl sm:text-3xl text-white mb-3">Cosa doveva essere raccontato</h3>
          ...
          <div className="border-l-2 border-[#28282D] pl-6 py-1">
            ...
            <h3 className="font-serif italic text-2xl sm:text-3xl text-white mb-3">La scelta narrativa e visiva</h3>
            <p className="text-sm sm:text-base text-[#C9C7C1] font-sans leading-relaxed text-pretty">
              {project.pointOfView}
            </p>
          </div>
          ...
          <div className="border-l-2 border-[#28282D] pl-6 py-1">
            ...
            <h3 className="font-serif italic text-2xl sm:text-3xl text-white mb-3">Come è stato costruito il lavoro</h3>
            <p className="text-sm sm:text-base text-[#C9C7C1] font-sans leading-relaxed text-pretty">
              {project.process}
            </p>
          </div>
          ...
          {project.outcome && (
            <div className="border-l-2 border-[#28282D] pl-6 py-1">
              ...
              <h3 className="font-serif italic text-2xl sm:text-3xl text-white mb-3">L’impatto del racconto</h3>
              <p className="text-sm sm:text-base text-[#C9C7C1] font-sans leading-relaxed text-pretty">
                {project.outcome}
              </p>
            </div>
